    ...
    <div class="container">
        ...
        <div class="offcanvas offcanvas-start" tabindex="-1" id="primaryNav">
            <div class="offcanvas-header">
                <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><i class="bi bi-search"></i>DocVerifica </h5>
                <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                        aria-label="Close"></button>
            </div>
            <div class="offcanvas-body">
                <a class="navbar-brand d-none d-lg-inline-flex" href="/">
                    <i class="bi bi-search" style="color: #03285e;"></i>
                    <span style="color: #333;"> &nbsp; docverifica.com.br</span>
                </a>
